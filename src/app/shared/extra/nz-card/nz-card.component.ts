import { Component, ViewEncapsulation, TemplateRef, Input, ContentChildren,
     QueryList, OnInit, AfterViewInit, ElementRef, Renderer2,
     OnChanges, SimpleChanges, ContentChild, EventEmitter, Output } from '@angular/core';
