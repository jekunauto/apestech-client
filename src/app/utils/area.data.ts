export const city_data = {
    ...
    '河北省': {
        '保定市': ['安国市', '安新县', '北市区', '博野县', '定兴县', '定州市', '阜平县', '高碑店', '高阳县', '涞水县', '涞源县', '蠡县', '满城县', '南市区', '清苑县', '曲阳县', '容城县', '顺平县', '唐县', '望都县', '新市区', '雄县', '徐水县', '易县', '涿州市'],
        '沧州市': ['泊头市', '沧县', '东光县', '海兴县', '河间市', '黄骅市', '孟村回族自治县', '南皮县', '青县', '任丘市', '肃宁县', '吴桥县', '献县', '新华区', '盐山县', '运河区'],
        '承德市': ['承德县', '丰宁满族自治县', '宽城满族自治县', '隆化县', '滦平县', '平泉县', '双滦区', '双桥区', '围场满族蒙古族自治县', '兴隆县', '鹰手营子矿区'],
        '邯郸市': ['成安县', '磁县', '丛台区', '大名县', '肥乡县', '峰峰矿区', '复兴区', '馆陶县', '广平县', '邯郸县', '邯山区', '鸡泽县', '临漳县', '邱县', '曲周县', '涉县', '魏县', '武安市', '永年县'],
        '衡水市': ['安平县', '阜城县', '故城县', '冀州市', '景县', '饶阳县', '深州市', '桃城区', '武强县', '武邑县', '枣强县'],
        '廊坊市': ['安次区', '霸州市', '大厂回族自治县', '大城县', '固安县', '广阳区', '三河市', '文安县', '香河县', '永清县'],
        '秦皇岛市': ['北戴河区', '昌黎县', '抚宁县', '海港区', '卢龙县', '青龙满族自治县', '山海关区'],
        '石家庄市': ['高邑县', '藁城市', '行唐县', '晋州市', '井陉矿区', '井陉县', '灵寿县', '鹿泉市', '栾城县', '平山县', '桥东区', '桥西区', '深泽县', '无极县', '辛集市', '新华区', '新乐市', '裕华区', '元氏县', '赞皇县', '长安区', '赵县', '正定县'],
        '唐山市': ['曹妃甸区', '丰南区', '丰润区', '古冶区', '开平区', '乐亭县', '路北区', '路南区', '滦南县', '滦县', '迁安市', '迁西县', '玉田县', '遵化市'],
        '邢台市': ['柏乡县', '广宗县', '巨鹿县', '临城县', '临西县', '隆尧县', '南宫市', '南和县', '内丘县', '宁晋县', '平乡县', '桥东区', '桥西区', '清河县', '任县', '沙河市', '威县', '新河县', '邢台县'],
        '张家口市': ['赤城县', '崇礼县', '沽源县', '怀安县', '怀来县', '康保县', '桥东区', '桥西区', '尚义县', '万全县', '蔚县', '下花园区', '宣化区', '宣化县', '阳原县', '张北县', '涿鹿县']
    },
    ...
    '广东省': {
        '广州市': ['越秀区', '荔湾区', '海珠区', '天河区', '白云区', '黄埔区', '花都区', '番禺区', '南沙区', '增城区', '从化区'],
        '深圳市': ['福田区', '罗湖区', '南山区', '盐田区', '宝安区', '龙岗区'],
        '珠海市': ['香洲区', '斗门区', '金湾区'],
        '汕头市': ['金平区', '龙湖区', '濠江区', '潮南区', '潮阳区', '澄海区', '南澳县'],
        '佛山市': ['禅城区', '高明区', '三水区', '南海区', '顺德区'],
        '韶关市': ['浈江区', '武江区', '曲江区', '乐昌市', '南雄市', '始兴县', '仁化县', '翁源县', '新丰县', '乳源瑶族自治县'],
        '湛江市': ['赤坎区', '霞山区', '坡头区', '麻章区', '廉江市', '吴川市', '雷州市', '遂溪县', '徐闻县'],
        '肇庆市': ['端州区', '鼎湖区', '高要市', '四会市', '广宁县', '怀集县', '封开县', '德庆县'],
        '江门市': ['江海区', '蓬江区', '新会区', '台山市', '鹤山市', '开平市', '恩平市 '],
    ...
    '甘肃省': {
        ...
        '定西市': ['安定区', '临洮县', '陇西县', '岷县', '通渭县', '渭源县', '漳县'],
        '甘南藏族自治州': ['迭部县', '合作市', '临潭县', '碌曲县', '玛曲县', '夏河县', '舟曲县', '卓尼县'],
        '嘉峪关市': ['嘉峪关'],
        '金昌市': ['金川区', '永昌县'],
        '酒泉市': ['阿克塞哈萨克族自治县', '敦煌市', '瓜州县', '金塔县', '肃北蒙古族自治县', '肃州区', '玉门市'],
        '兰州市': ['安宁区', '城关区', '皋兰县', '红古区', '七里河区', '西固区', '永登县', '榆中县'],
        '临夏回族自治州': ['东乡族自治县', '广河县', '和政县', '积石山保安族东乡族撒拉族自治县', '康乐县', '临夏市', '临夏县', '永靖县'],
        '陇南市': ['成县', '宕昌县', '徽县', '康县', '礼县', '两当县', '文县', '武都区', '西和县'],
        '平凉市': ['崇信县', '华亭县', '泾川县', '静宁县', '崆峒区', '灵台县', '庄浪县'],
        '庆阳市': ['合水县', '华池县', '环县', '宁县', '庆城县', '西峰区', '镇原县', '正宁县'],
        '天水市': ['甘谷县', '麦积区', '秦安县', '秦州区', '清水县', '武山县', '张家川回族自治县'],
        '武威市': ['古浪县', '凉州区', '民勤县', '天祝藏族自治县'],
        '张掖市': ['甘州区', '高台县', '临泽县', '民乐县', '山丹县', '肃南裕固族自治县']
    },
    '湖北省': {
        '鄂州市': ['鄂城区', '华容区', '梁子湖区'],
        '恩施土家族苗族自治州': ['巴东县', '恩施市', '鹤峰县', '建始县', '来凤县', '利川市', '咸丰县', '宣恩县'],
        '黄冈市': ['红安县', '黄梅县', '黄州区', '罗田县', '麻城市', '蕲春县', '团风县', '武穴市', '浠水县', '英山县'],
        '黄石市': ['大冶市', '黄石港区', '铁山区', '西塞山区', '下陆区', '阳新县'],
        '荆州市': ['东宝区', '掇刀区', '京山县', '沙洋县', '钟祥市', '公安县', '洪湖市', '监利县', '江陵县', '荆州区', '沙市区', '石首市', '松滋市'],
        '省直辖县级行政区划': ['潜江市', '神农架林区', '天门市', '仙桃市'],
        '十堰市': ['丹江口市', '房县', '茅箭区', '郧西县', '郧县', '张湾区', '竹山县', '竹溪县'],
        '随州市': ['曾都区', '广水市', '随县'],
        '武汉市': ['蔡甸区', '东西湖区', '汉南区', '汉阳区', '洪山区', '黄陂区', '江岸区', '江汉区', '江夏区', '硚口区', '青山区', '武昌区', '新洲区'],
        '咸宁市': ['赤壁市', '崇阳县', '嘉鱼县', '通城县', '通山县', '咸安区'],
        '襄阳市': ['保康县', '樊城区', '谷城县', '老河口市', '南漳县', '襄城区', '襄州区', '宜城市', '枣阳市'],
        '孝感市': ['安陆市', '大悟县', '汉川市', '孝昌县', '孝南区', '应城市', '云梦县'],
        '宜昌市': ['当阳市', '点军区', '五峰土家族自治县', '伍家岗区', '西陵区', '猇亭区', '兴山县', '夷陵区', '宜都市', '远安县', '长阳土家族自治县', '枝江市', '秭归县']
    },
    '湖南省': {
        '常德市': ['安乡县', '鼎城区', '汉寿县', '津市市', '澧县', '临澧县', '石门县', '桃源县', '武陵区'],
        '郴州市': ['安仁县', '北湖区', '桂东县', '桂阳县', '嘉禾县', '临武县', '汝城县', '苏仙区', '宜章县', '永兴县', '资兴市'],
        '衡阳市': ['常宁市', '衡东县', '衡南县', '衡山县', '衡阳县', '耒阳市', '南岳区', '祁东县', '石鼓区', '雁峰区', '蒸湘区', '珠晖区'],
        '怀化市': ['辰溪县', '鹤城区', '洪江市', '会同县', '靖州苗族侗族自治县', '麻阳苗族自治县', '通道侗族自治县', '新晃侗族自治县', '溆浦县', '沅陵县', '芷江侗族自治县', '中方县'],
        '娄底市': ['冷水江市', '涟源市', '娄星区', '双峰县', '新化县'],
        '邵阳市': ['北塔区', '城步苗族自治县', '大祥区', '洞口县', '隆回县', '邵东县', '邵阳县', '双清区', '绥宁县', '武冈市', '新宁县', '新邵县'],
        '湘潭市': ['韶山市', '湘潭县', '湘乡市', '雨湖区', '岳塘区'],
        '湘西土家族苗族自治州': ['保靖县', '凤凰县', '古丈县', '花垣县', '吉首市', '龙山县', '泸溪县', '永顺县'],
        '益阳市': ['安化县', '赫山区', '南县', '桃江县', '沅江市', '资阳区'],
        '永州市': ['道县', '东安县', '江华瑶族自治县', '江永县', '蓝山县', '冷水滩区', '零陵区', '宁远县', '祁阳县', '双牌县', '新田县'],
        '岳阳市': ['华容县', '君山区', '临湘市', '汨罗市', '平江县', '湘阴县', '岳阳县', '岳阳楼区', '云溪区'],
        '张家界市': ['慈利县', '桑植县', '武陵源区', '永定区'],
        '长沙市': ['芙蓉区', '开福区', '浏阳市', '宁乡县', '天心区', '望城区', '雨花区', '岳麓区', '长沙县'],
        '株洲市': ['茶陵县', '荷塘区', '醴陵市', '芦淞区', '石峰区', '天元区', '炎陵县', '攸县', '株洲县']
    },
    '四川省': {
    ...
    '河南省': {
        ...
        '濮阳市': ['华龙区', '清丰县', '南乐县', '范县', '台前吴桥县', '献县', '孟村回族自治县', '泊头市', '任丘市', '黄骅市', '河间市'],
    ...
    '青海省': {
        ...
        '海东市': ['互助土族自治县', '化隆回族自治县', '乐都区', '民和回族土族自治县', '平安县', '循化撒拉族自治县'],
        '海南藏族自治州': ['共和县', '贵德县', '贵南县', '同德县', '兴海县'],
        '海西蒙古族藏族自治州': ['德令哈市', '都兰县', '格尔木市', '天峻县', '乌兰县'],
        '黄南藏族自治州': ['河南蒙古族自治县', '尖扎县', '同仁县', '泽库县'],
        '西宁市': ['城北区', '城东区', '城西区', '城中区', '大通回族土族自治县', '湟源县', '湟中县'],
        '玉树藏族自治州': ['称多县', '囊谦县', '曲麻莱县', '玉树市', '杂多县', '治多县']
    },
    '陕西省': {
        '安康市': ['白河县', '汉滨区', '汉阴县', '岚皋县', '宁陕县', '平利县', '石泉县', '旬阳县', '镇坪县', '紫阳县'],
        '宝鸡市': ['陈仓区', '凤县', '凤翔县', '扶风县', '金台区', '麟游县', '陇县', '眉县', '岐山县', '千阳县', '太白县', '渭滨区'],
        '汉中市': ['城固县', '佛坪县', '汉台区', '留坝县', '略阳县', '勉县', '南郑县', '宁强县', '西乡县', '洋县', '镇巴县'],
        '商洛市': ['丹凤县', '洛南县', '山阳县', '商南县', '商州区', '柞水县', '镇安县'],
        '铜川市': ['王益区', '耀州区', '宜君县', '印台区'],
        '渭南市': ['白水县', '澄城县', '大荔县', '富平县', '韩城市', '合阳县', '华县', '华阴市', '临渭区', '蒲城县', '潼关县'],
        '西安市': ['灞桥区', '碑林区', '高陵县', '户县', '蓝田县', '莲湖区', '临潼区', '未央区', '新城区', '阎良区', '雁塔区', '长安区', '周至县'],
        '咸阳市': ['彬县', '淳化县', '泾阳县', '礼泉县', '乾县', '秦都区', '三原县', '渭城区', '武功县', '兴平市', '旬邑县', '杨陵区', '永寿县', '长武县'],
        '延安市': ['安塞县', '宝塔区', '富县', '甘泉县', '黄陵县', '黄龙县', '洛川县', '吴起县', '延川县', '延长县', '宜川县', '志丹县', '子长县'],
        '榆林市': ['定边县', '府谷县', '横山县', '佳县', '靖边县', '米脂县', '清涧县', '神木县', '绥德县', '吴堡县', '榆阳区', '子洲县']
    },
    '吉林省': {
    ...
    '广西壮族自治区': {
        '南宁市': ['青秀区', '兴宁区', '西乡塘区', '江南区', '良庆区', '邕宁区', '武鸣县', '隆安县', '马山县', '上林县', '宾阳县', '横县'],
        ...
        '河池市': ['金城江区', '宜州市', '南丹县', '天峨县', '凤山县', '东兰县', '巴马瑶族自治县', '都安瑶族自治县', '大化瑶族自治县', '罗城仫佬族自治县', '环江毛南族自治县'],
    ...
    '新疆维吾尔自治区': {
        '阿克苏地区': ['阿克苏市', '阿瓦提县', '拜城县', '柯坪县', '库车县', '沙雅县  ', '温宿县', '乌什县', '新和县  ', '阿勒泰市', '布尔津县', '福海县  ', '富蕴县  ', '哈巴河县', '吉木乃县', '青河县'],
        '巴音郭楞蒙古自治州': ['博湖县', '和静县', '和硕县', '库尔勒市', '轮台县', '且末县', '若羌县', '尉犁县', '焉耆回族自治县', '阿拉山口市', '博乐市', '精河县', '温泉县'],
        '昌吉回族自治州': ['昌吉市', '阜康市', '呼图壁县', '吉木萨尔县', '玛纳斯县', '木垒哈萨克自治县', '奇台县'],
        '哈密地区': ['巴里坤哈萨克自治县', '哈密市', '伊吾县'],
        '和田地区': ['策勒县', '和田市', '和田县', '洛浦县', '民丰县', '墨玉县', '皮山县', '于田县'],
        '喀什地区': ['巴楚县', '伽师县', '喀什市', '麦盖提县', '莎车县', '疏附县', '疏勒县', '塔什库尔干塔吉克自治县', '叶城县', '英吉沙县', '岳普湖县', '泽普县'],
        ...
        '图木舒克市': ['图木舒克市'],
        '五家渠市': ['五家渠市'],
        '塔城地区': ['额敏县', '和布克赛尔蒙古自治县', '沙湾县', '塔城市', '托里县', '乌苏市', '裕民县'],
        '吐鲁番地区': ['鄯善县', '吐鲁番市', '托克逊县'],
        '乌鲁木齐市': ['达坂城区', '米东区', '沙依巴克区', '水磨沟区', '天山区', '头屯河区', '乌鲁木齐县', '新市区'],
        '伊犁哈萨克自治州': ['察布查尔锡伯自治县', '巩留县', '霍城县', '奎屯市', '尼勒克县', '特克斯县', '新源县', '伊宁市', '伊宁县', '昭苏县']
    },
    '西藏自治区': {
        '阿里地区': ['措勤县', '噶尔县', '改则县', '革吉县', '普兰县', '日土县', '札达县'],
        '昌都地区': ['八宿县', '边坝县', '察雅县', '昌都县', '丁青县', '贡觉县', '江达县', '类乌齐县', '洛隆县', '芒康县', '左贡县'],
        '拉萨市': ['城关区', '达孜县', '当雄县', '堆龙德庆县', '林周县', '墨竹工卡县', '尼木县', '曲水县'],
        '林芝地区': ['波密县', '察隅县', '工布江达县', '朗县', '林芝县', '米林县', '墨脱县'],
        '那曲地区': ['安多县', '巴青县', '班戈县', '比如县', '嘉黎县', '那曲县', '尼玛县', '聂荣县', '申扎县', '双湖县', '索县'],
        '日喀则地区': ['昂仁县', '白朗县', '定结县', '定日县', '岗巴县', '吉隆县', '江孜县', '康马县', '拉孜县', '南木林县', '聂拉木县', '仁布县', '日喀则市', '萨嘎县', '萨迦县', '谢通门县', '亚东县', '仲巴县'],
        '山南地区': ['措美县', '错那县', '贡嘎县', '加查县', '浪卡子县', '隆子县', '洛扎县', '乃东县', '琼结县', '曲松县', '桑日县', '扎囊县']
    },
    '台湾省': {'台湾': []},
    '澳门特别行政区': {'澳门特别行政区': []},
    '香港特别行政区': {'香港特别行政区': []}
